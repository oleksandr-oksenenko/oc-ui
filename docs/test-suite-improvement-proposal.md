...
| Native lifecycle and settings                             | Keep lazy startup, settings encryption/forget, crash/manual restart, shutdown child/PTY settlement, preload access, signature/architecture checks, and embedded browser cleanup.                                                                                                                  |
